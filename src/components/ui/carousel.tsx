...
function CarouselDotButton({
  ...
  return (
    <Button
      ...
      variant={variant}
      size={size}
      className={cn("size-2 rounded-full transition-all", isSelected ? "w-5" : "opacity-50", className)}
...
function CarouselDots({ className, ...props }: React.ComponentProps<"div">) {
  ...
  return (
    <div
      ...
      className={cn(
        "absolute bottom-5 z-10 left-1/2 -translate-x-1/2 flex items-center justify-center gap-2",
        className,
      )}
      {...props}
    >
